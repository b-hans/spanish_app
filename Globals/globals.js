...
const IRREGULAR_PARTICIPLES = SpreadsheetApp.getActiveSpreadsheet()
    .getSheetByName('irregular participles');
...
const VERB_SEARCH_TITLE_RANGE =  FORMSHEET.getRange("E5");
const VERB_SEARCH_INPUT_RANGE = FORMSHEET.getRange("F5");
